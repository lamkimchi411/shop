        ...
        <div style="display: grid; grid-template-columns: 0.9fr 1.1fr; gap: 30px;">
            ...
            <div class="heritage-table-container" style="padding: 28px;">
                <h3 style="font-family: var(--font-heading); font-size: 1.3rem; color: var(--primary-red); margin-bottom: 18px; padding-bottom: 10px; border-bottom: 2px solid var(--gold-accent);">
                    <i class="fa-solid fa-folder-plus"></i> ${category != null ? 'CẬP NHẬT DANH MỤC' : 'THÊM DANH MỤC MỚI'}
                </h3>
                ...
                <form action="${pageContext.request.contextPath}/admin/categories" method="post">
                    ...
                    <div class="form-group-heritage">
                        ...
                        <div class="form-input-wrapper">
                            ...
                            <input type="text" id="name" name="name" value="${category != null ? category.name : ''}" class="form-control-heritage" placeholder="Ví dụ: Áo Nhật Bình Cung Đình..." required />
                        </div>
                    </div>

                    <div class="form-group-heritage">
                        <label for="description">Mô Tả Danh Mục</label>
                        <textarea id="description" name="description" class="form-control-heritage" style="border-radius: var(--radius-md); height: 100px; padding: 12px 16px;" placeholder="Giới thiệu về dòng trang phục di sản này...">${category != null ? category.description : ''}</textarea>
                    </div>
