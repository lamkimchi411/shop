            ...
            <form action="${pageContext.request.contextPath}/admin/products" method="post" enctype="multipart/form-data">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                    ...
                    <div class="form-group-heritage">
                        ...
                        <input id="imageFile" type="file" name="imageFile" accept="image/*" style="margin-top: 8px; font-size: 0.82rem;" />
                        <small id="uploadStatus" style="display: block; margin-top: 6px; color: var(--text-muted);"></small>
                    </div>
                </div>
